...
cp ../tcl $LANGUAGE_PATH/bin/
if [[ $INCLUDE_TCLNATIVE = "TRUE" ]]; then
    cp ../native/tclnative $LANGUAGE_PATH/bin/
fi
...
mkdir -p "$COMPONENT_DIR/META-INF"
{
    ...
    echo "Bundle-Symbolic-Name: com.oracle.truffle.tcl";
...
jar cfm ../tcl-component.jar META-INF/MANIFEST.MF .

echo "bin/tcl = ../$JRE/languages/tcl/bin/tcl" > META-INF/symlinks
if [[ $INCLUDE_TCLNATIVE = "TRUE" ]]; then
    echo "bin/tclnative = ../$JRE/languages/tcl/bin/tclnative" >> META-INF/symlinks
fi
jar uf ../tcl-component.jar META-INF/symlinks

{
    echo "$JRE"'languages/tcl/bin/tcl = rwxrwxr-x'
    echo "$JRE"'languages/tcl/bin/tclnative = rwxrwxr-x'
} > META-INF/permissions
jar uf ../tcl-component.jar META-INF/permissions
)
rm -rf $COMPONENT_DIR

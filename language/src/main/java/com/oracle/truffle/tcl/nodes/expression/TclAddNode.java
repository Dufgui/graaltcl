 ...
 * are automatically generated by the Truffle DSL. In addition, a {@link TclAddNodeGen factory class}
...
public abstract class TclAddNode
     ...
     * the {@link #add(TclBigNumber, TclBigNumber) slow path}. Therefore, we use an
    ...
    /**
     * This is the slow path of the arbitrary-precision arithmetic. The {@link TclBigNumber} type of
     * Java is doing everything we need.
     * <p>
     * This specialization is automatically selected by the Truffle DSL if both the left and right
     * operand are {@link TclBigNumber} values. Because the type system defines an
     * {@link ImplicitCast implicit conversion} from {@code long} to {@link TclBigNumber} in
     * {@link TclTypes#castBigNumber(long)}, this specialization is also taken if the left or the
    ...
    /**
     * Specialization for String concatenation. The tcl specification says that String concatenation

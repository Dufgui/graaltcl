...
public abstract class TclWriteLocalVariableNode extends TclExpressionNode {
    ...
    /**
     * Returns the child node <code>nameNode</code>. The implementation of this
     * method is created by the Truffle DSL based on the {@link NodeChild}
     * annotation on the class.
     */
    protected abstract TclExpressionNode getNameNode();

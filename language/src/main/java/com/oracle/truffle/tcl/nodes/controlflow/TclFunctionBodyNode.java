...
public final class TclFunctionBodyNode
        extends
        TclExpressionNode {
     ...
     * code.
     */
    private final BranchProfile exceptionTaken = BranchProfile
            .create();
    private final BranchProfile nullTaken = BranchProfile
            .create();

    public TclFunctionBodyNode(

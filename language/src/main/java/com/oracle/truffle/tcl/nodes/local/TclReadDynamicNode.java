...
public abstract class TclReadDynamicNode extends TclExpressionNode {
    ...
    protected Object readObject(VirtualFrame frame) {
        FrameSlot slot = getLexicalScope().getLocal(getName());
    ...
    public Object getNodeObject() {
        return NodeObjectDescriptor.readVariable(getName());
    }
}

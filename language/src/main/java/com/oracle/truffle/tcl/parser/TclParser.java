...
public class TclParser extends Parser {
	...
	public static final int
		...
		T__31=32, T__32=33, T__33=34, COMMENT=35, WS=36, IDENTIFIER=37, STRING_LITERAL=38, 
		INTEGER_LITERAL=39, DOUBLE_LITERAL=40;
	public static final int
		RULE_tcl = 0, RULE_function = 1, RULE_block = 2, RULE_module = 3, RULE_statement = 4, 
		RULE_while_statement = 5, RULE_if_statement = 6, RULE_return_statement = 7, 
		RULE_expression = 8, RULE_logic_term = 9, RULE_logic_factor = 10, RULE_arithmetic = 11, 
		RULE_term_add = 12, RULE_term_pot = 13, RULE_term = 14, RULE_member_expression = 15;
	public static final String[] ruleNames = {
		"tcl", "function", "block", "module", "statement", "while_statement", 
		"if_statement", "return_statement", "expression", "logic_term", "logic_factor", 
		"arithmetic", "term_add", "term_pot", "term", "member_expression"
	};
	...
	private static final String[] _SYMBOLIC_NAMES = {
		...
		"WS", "IDENTIFIER", "STRING_LITERAL", "INTEGER_LITERAL", "DOUBLE_LITERAL"
	};
	...
	public final BlockContext block(boolean inLoop) throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__4) | (1L << T__6) | (1L << T__7) | (1L << T__8) | (1L << T__11) | (1L << T__28) | (1L << IDENTIFIER) | (1L << STRING_LITERAL) | (1L << INTEGER_LITERAL) | (1L << DOUBLE_LITERAL))) != 0)) {
				{
				{
				setState(64);
	...
	public final ModuleContext module() throws RecognitionException {
		...
		try {
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__4) | (1L << T__6) | (1L << T__7) | (1L << T__8) | (1L << T__11) | (1L << T__28) | (1L << IDENTIFIER) | (1L << STRING_LITERAL) | (1L << INTEGER_LITERAL) | (1L << DOUBLE_LITERAL))) != 0)) {
				...
				{
				setState(75);
				((ModuleContext)_localctx).statement = statement(false);
				 factory.addModuleStatement(((ModuleContext)_localctx).statement.result); 
				}
				}
				setState(82);
				_errHandler.sync(this);
	...
	public final StatementContext statement(boolean inLoop) throws RecognitionException {
		...
		try {
			...
			case T__6:
				{
				setState(89);
				((StatementContext)_localctx).c = match(T__6);
	...
	public final Return_statementContext return_statement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__28) | (1L << IDENTIFIER) | (1L << STRING_LITERAL) | (1L << INTEGER_LITERAL) | (1L << DOUBLE_LITERAL))) != 0)) {
				{
				setState(128);
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					{
					setState(190);
					((Term_potContext)_localctx).op = match(T__27);
					setState(191);
					((Term_potContext)_localctx).term = term();
	...
	public final TermContext term() throws RecognitionException {
		...
		try {
			...
			case STRING_LITERAL:
				{
				setState(207);
				((TermContext)_localctx).STRING_LITERAL = match(STRING_LITERAL);
				 ((TermContext)_localctx).result =  factory.createStringLiteral(((TermContext)_localctx).STRING_LITERAL, true); 
				}
				break;
			case INTEGER_LITERAL:
				{
				setState(209);
				((TermContext)_localctx).INTEGER_LITERAL = match(INTEGER_LITERAL);
				 ((TermContext)_localctx).result =  factory.createIntegerLiteral(((TermContext)_localctx).INTEGER_LITERAL); 
				}
				break;
			case DOUBLE_LITERAL:
				{
				setState(211);
				((TermContext)_localctx).DOUBLE_LITERAL = match(DOUBLE_LITERAL);
				 ((TermContext)_localctx).result =  factory.createDoubleLiteral(((TermContext)_localctx).DOUBLE_LITERAL); 
				}
				break;
			case T__28:
				{
				setState(213);
				((TermContext)_localctx).s = match(T__28);
				setState(214);
				((TermContext)_localctx).expr = expression();
				setState(215);
				((TermContext)_localctx).e = match(T__29);
				 ((TermContext)_localctx).result =  factory.createParenExpression(((TermContext)_localctx).expr.result, ((TermContext)_localctx).s.getStartIndex(), ((TermContext)_localctx).e.getStopIndex() - ((TermContext)_localctx).s.getStartIndex() + 1); 
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Member_expressionContext member_expression(SLExpressionNode r,SLExpressionNode assignmentReceiver,SLExpressionNode assignmentName) throws RecognitionException {
		...
		try {
			...
			case T__28:
				...
				setState(236);
				((Member_expressionContext)_localctx).e = match(T__29);

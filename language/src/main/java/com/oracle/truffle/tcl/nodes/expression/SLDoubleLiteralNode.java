 ...
 * parent expects a long value and calls {@link SLDoubleLiteralNode#executeLong}. In the generic case,
 * the primitive value is automatically boxed by Java.
 */
@NodeInfo(shortName = "const")
public final class SLDoubleLiteralNode extends SLExpressionNode {

    private final double value;

    public SLDoubleLiteralNode( double value) {
        this.value = value;
    }

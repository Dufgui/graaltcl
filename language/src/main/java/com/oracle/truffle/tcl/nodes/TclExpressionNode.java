...
/**
 * Base class for all Tcl nodes that produce a value and therefore benefit from
 * type specialization. The annotation {@link TypeSystemReference} specifies the
 * Tcl types. Specifying it here defines the type system for all subclasses.
 */
...
public abstract class TclExpressionNode extends TclStatementNode {
    ...
    /**
     * When we use an expression at places where a {@link TclStatementNode

...
import com.oracle.truffle.tcl.nodes.TclBinaryNode;
 ...
 */
@NodeInfo(shortName = "**")
public abstract class TclExponentNode extends TclBinaryNode {

    @Specialization(rewriteOn = ArithmeticException.class)
    protected double exponent(double left, double right) throws ArithmeticException {
        return Math.pow(left, right);
    }

    @Specialization
    @TruffleBoundary
    protected TclBigNumber modulo(TclBigNumber left, TclBigNumber right) {
        return new TclBigNumber(left.getValue().pow(right.getValue().intValue()));
    }

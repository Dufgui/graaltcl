...
import com.oracle.truffle.tcl.nodes.controlflow.SLBlockNode;
import com.oracle.truffle.tcl.nodes.controlflow.SLBreakNode;
import com.oracle.truffle.tcl.nodes.controlflow.SLContinueNode;
import com.oracle.truffle.tcl.nodes.controlflow.SLDebuggerNode;
import com.oracle.truffle.tcl.nodes.controlflow.SLFunctionBodyNode;
import com.oracle.truffle.tcl.nodes.controlflow.SLIfNode;
import com.oracle.truffle.tcl.nodes.controlflow.SLReturnNode;
import com.oracle.truffle.tcl.nodes.controlflow.SLWhileNode;
import com.oracle.truffle.tcl.nodes.expression.SLAddNodeGen;
import com.oracle.truffle.tcl.nodes.expression.SLBigIntegerLiteralNode;
import com.oracle.truffle.tcl.nodes.expression.SLDivNodeGen;
import com.oracle.truffle.tcl.nodes.expression.SLEqualNodeGen;
import com.oracle.truffle.tcl.nodes.expression.SLFunctionLiteralNode;
import com.oracle.truffle.tcl.nodes.expression.SLInvokeNode;
import com.oracle.truffle.tcl.nodes.expression.SLLessOrEqualNodeGen;
import com.oracle.truffle.tcl.nodes.expression.SLLessThanNodeGen;
import com.oracle.truffle.tcl.nodes.expression.SLLogicalAndNode;
import com.oracle.truffle.tcl.nodes.expression.SLLogicalNotNodeGen;
import com.oracle.truffle.tcl.nodes.expression.SLLogicalOrNode;
import com.oracle.truffle.tcl.nodes.expression.SLLongLiteralNode;
import com.oracle.truffle.tcl.nodes.expression.SLMulNodeGen;
import com.oracle.truffle.tcl.nodes.expression.SLParenExpressionNode;
import com.oracle.truffle.tcl.nodes.expression.SLReadPropertyNode;
import com.oracle.truffle.tcl.nodes.expression.SLReadPropertyNodeGen;
import com.oracle.truffle.tcl.nodes.expression.SLStringLiteralNode;
import com.oracle.truffle.tcl.nodes.expression.SLSubNodeGen;
import com.oracle.truffle.tcl.nodes.expression.SLWritePropertyNode;
import com.oracle.truffle.tcl.nodes.expression.SLWritePropertyNodeGen;
import com.oracle.truffle.tcl.nodes.local.SLReadArgumentNode;
import com.oracle.truffle.tcl.nodes.local.SLReadLocalVariableNode;
import com.oracle.truffle.tcl.nodes.local.SLReadLocalVariableNodeGen;
import com.oracle.truffle.tcl.nodes.local.SLWriteLocalVariableNode;
import com.oracle.truffle.tcl.nodes.local.SLWriteLocalVariableNodeGen;
import com.oracle.truffle.tcl.nodes.util.SLUnboxNodeGen;
...
public class TclNodeFactory
{
    ...
    public TclNodeFactory( SLLanguage language, Source source) {

...
public class TclInstrumentLegacyTest {
    ...
    public void testLexicalScopes()
        ...
        try (Engine engine = Engine
            ...
            Instrument envInstr = engine
                    .getInstruments()
                    .get("testEnvironmentHandlerLegacyInstrument");
                    ...
                    .attachExecutionEventListener(
                            ...
                            new ExecutionEventListener() {
                                ...
                                public void onEnter(
                                    ...
                                    Node node = context
                                            .getInstrumentedNode();
                                    Iterable<com.oracle.truffle.api.Scope> lexicalScopes = env
                                            .findLocalScopes(
                                                    node,
                                                    null);
                                    Iterable<com.oracle.truffle.api.Scope> dynamicScopes = env
                                            .findLocalScopes(
                                                    node,
                                                    frame);
                                    try {
    ...
    private static void verifyLexicalScopes(
            Iterable<com.oracle.truffle.api.Scope> lexicalScopes,
            Iterable<com.oracle.truffle.api.Scope> dynamicScopes,
            int line,
            ...
            case 2:
                for (com.oracle.truffle.api.Scope ls : lexicalScopes) {
                    ...
                    checkRootNode(
                            ...
                            "test",
                            frame);
                    TruffleObject arguments = (TruffleObject) ls
                            .getArguments();
                    checkVars(
                            arguments,
                            "n",
                            null);
                    TruffleObject variables = (TruffleObject) ls
                            .getVariables();
                    checkVars(
                            variables,
                            "n",
    ...
    private static void checkRootNode(
            com.oracle.truffle.api.Scope ls,
            String name,
            MaterializedFrame frame) {
        assertEquals(
                name,
    ...
    public void testRedoIO()
        ...
        InputStream delegateInputStream = new InputStream() {
            ...
            public int read()
                    throws IOException {
                synchronized (TclInstrumentLegacyTest.class) {
                    // Block reading before we do unwind:
                    if (redoIOPtr[0].beforePop) {
                        redoIOPtr[0].inRead
                                .release();
                        try {
                            TclInstrumentLegacyTest.class
                                    .wait();
        ...
        Engine engine = Engine
                ...
                .build();
        TestRedoIOLegacy redoIO = engine
                .getInstruments()
                .get("testRedoIOLegacy")
                .lookup(TestRedoIOLegacy.class);
        redoIOPtr[0] = redoIO;
        redoIO.inRead
                .drainPermits();
        Context context = Context
    ...
    public static class TestRedoIOLegacy
            extends
            TruffleInstrument {
    ...
    public void testEarlyReturn()
        ...
        EarlyReturnLegacyInstrument earlyReturn = context
                .getEngine()
                .getInstruments()
                .get("testEarlyReturnLegacy")
                .lookup(EarlyReturnLegacyInstrument.class);
    ...
    public static class EarlyReturnLegacyInstrument
            extends
            TruffleInstrument {
    ...
    public void testReplaceNodeReturnValue()
        ...
        Context context = Context
                .create();
        NewReplacedInstrumentLegacy replaced = context
                .getEngine()
                .getInstruments()
                .get("testNewNodeReplacedLegacy")
                .lookup(NewReplacedInstrumentLegacy.class);
        replaced.attachAt(
                ss);
    ...
    public static final class NewReplacedInstrumentLegacy
            extends
            TruffleInstrument {
        ...
        static class ReplacedTruffleObjectLegacy
                implements
                TruffleObject {
    ...
    @ExportLibrary(InteropLibrary.class)
    static final class KeysArrayLegacy
            implements
            TruffleObject {
    ...
    public void testChangeArgumentsOnReenter()
        ...
        Context context = Context
                .create();
        IncreaseArgOnErrorLegacyInstrument incOnError = context
                .getEngine()
                .getInstruments()
                .get("testIncreaseArgumentOnErrorLegacy")
                .lookup(IncreaseArgOnErrorLegacyInstrument.class);
        incOnError
                .attachOn(
                        "A bad error");
    ...
    public static final class IncreaseArgOnErrorLegacyInstrument
            extends
            TruffleInstrument {
    ...
    public static class EnvironmentHandlerLegacyInstrument
            extends
            TruffleInstrument {

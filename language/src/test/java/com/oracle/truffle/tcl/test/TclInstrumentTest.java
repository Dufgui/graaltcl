...
public class TclInstrumentTest {
    ...
    public void testRedoIO() throws Throwable {
        String code = "function main() {\n" +
                        ...
                        "  return a;\n" +
                        "}\n";
        final Source ioWait = Source.newBuilder("tcl", code, "testing").build();
    ...
    public void testEarlyReturn() throws Exception {
        String code = "function main() {\n" +
                        ...
                        "  return x + 1;\n" +
                        "}\n";
        final Source source = Source.newBuilder("tcl", code, "testing").build();
        ByteArrayOutputStream engineOut = new ByteArrayOutputStream();
        ...
        earlyReturn.returnValue = new TclBigNumber(new BigInteger("-42"));
        ret = context.eval(source);
        assertTrue(ret.isNumber());

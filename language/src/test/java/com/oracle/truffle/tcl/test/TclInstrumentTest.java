...
/**
 * Test of tcl instrumentation.
 */
public class TclInstrumentTest {

    static final InteropLibrary INTEROP = LibraryFactory
            .resolve(
    ...
    public void testLexicalScopes()
        ...
        try (Engine engine = Engine
                ...
                .build()) {
            Instrument envInstr = engine
                    .getInstruments()
                    .get("testEnvironmentHandlerInstrument");
            TruffleInstrument.Env env = envInstr
                    .lookup(Environment.class).env;
                    ...
                    .attachExecutionEventListener(
                            ...
                            new ExecutionEventListener() {
                                ...
                                public void onReturnValue(
                                        ...
                                        Object result) {
                                    if (context
                                            .hasTag(StandardTags.StatementTag.class)) {
                                        verifyScopes(
                                                context,
                                                frame,
                                                false);
                                        ...
                                        verifyRootInstance(
                                                ...
                                                NodeLibrary
                                                        ...
                                                        .getRootInstance(
                                                                node,
                                                                frame));
                                        Object lexicalScope = NodeLibrary
                                                .getUncached()
                                                .getScope(
                                                        node,
                                                        null,
                                                        onEnter);
                                        Object dynamicScope = NodeLibrary
                                                .getUncached()
                                                .getScope(
                                                        node,
                                                        frame,
                                                        onEnter);
                                        Object lexicalArguments = findArguments(
                                                node,
                                                null);
                                        Object dynamicArguments = findArguments(
                                                node,
                                                frame);
                                        verifyLexicalScopes(
                                                onEnter,
                                ...
                                private void verifyRootInstance(
                                        Node node,
                                        Object rootInstance) {
                                    assertNotNull(
                                            rootInstance);
                                    TclFunction function = (TclFunction) rootInstance;
                                    assertEquals(
                                            node.getRootNode()
                                                    .getName(),
                                            function.getName());
                                ...
                                private Object findArguments(
                                        Node node,
                                        VirtualFrame frame)
                                        throws UnsupportedMessageException {
                                    Node rootTagNode = node;
                                    while (rootTagNode != null) {
                                        if (rootTagNode instanceof InstrumentableNode
                                                && ((InstrumentableNode) rootTagNode)
                                                        .hasTag(StandardTags.RootTag.class)) {
                                            break;
                                        }
                                        rootTagNode = rootTagNode
                                                .getParent();
                                    }
                                    if (rootTagNode == null) {
                                        return null;
    ...
    private static void verifyLexicalScopes(
            boolean onEnter,
            Object[] scopes,
            Object[] arguments,
            int line,
    ...
    private static void checkRootNode(
        ...
        assertTrue(
                InteropLibrary
                        ...
                        .hasSourceLocation(
                                scope));
        SourceSection section = InteropLibrary
                .getUncached()
                .getSourceLocation(
                        scope);
        Node scopeNode = findScopeNode(
                node,
                section);
        assertTrue(
                scopeNode
    ...
    private static Node findScopeNode(
            Node node,
    ...
    private static void checkVars(
        ...
        for (int s = 0; s < scopes.length; s++) {
            boolean lexical = s < scopes.length
                    / 2;
            Object vars = scopes[s];
            Object members = INTEROP
                    .getMembers(
                            vars);
            int numMembers = (int) INTEROP
                    .getArraySize(
                            members);
            ...
            String memberNames = memberNamesList
                    .toString();
            assertEquals(
                    memberNames,
                    expected.length
            ...
            for (int i = 0; i < expected.length; i += 2) {
                ...
                assertEquals(
                        ...
                        INTEROP.asString(
                                member));
                assertTrue(
                        INTEROP.hasSourceLocation(
                                member));
                if (lexical) {
                    assertFalse(
                            INTEROP.isMemberWritable(
                                    vars,
                                    name));
                    assertTrue(
                            isNull(read(
    ...
    private static boolean getParentScopes(
            Object[] scopes)
            throws UnsupportedMessageException {
    ...
    public void testOutput()
        ...
        // Check output
        Instrument outInstr = engine
                .getInstruments()
                .get("testEnvironmentHandlerInstrument");
        TruffleInstrument.Env env = outInstr
                .lookup(Environment.class).env;
        ByteArrayOutputStream consumedOut = new ByteArrayOutputStream();
        EventBinding<ByteArrayOutputStream> outputConsumerBinding = env
                .getInstrumenter()
                .attachOutConsumer(
                        consumedOut);
        assertEquals(
        ...
        context.eval(
                source);
        BufferedReader fromOutReader = new BufferedReader(
        ...
        EventBinding<ByteArrayOutputStream> outputConsumerBinding2 = env
                .getInstrumenter()
                .attachOutConsumer(
                        consumedOut2);
        assertEquals(
        ...
        context.eval(
                source);
        fromOutReader = new BufferedReader(
                new InputStreamReader(
                        new ByteArrayInputStream(
                                consumedOut
                                        .toByteArray())));
        BufferedReader fromOutReader2 = new BufferedReader(
                new InputStreamReader(
                        new ByteArrayInputStream(
                                consumedOut2
                                        .toByteArray())));
        ...
        assertTrue(
                consumedOut2
                        .size() > 0);
        fromOutReader2 = new BufferedReader(
                new InputStreamReader(
                        new ByteArrayInputStream(
                                consumedOut2
                                        .toByteArray())));
    ...
    public void testRedoIO()
        ...
        InputStream strIn = new ByteArrayInputStream(
                "O.K.".getBytes());
        InputStream delegateInputStream = new InputStream() {
            ...
            public int read()
                    throws IOException {
                synchronized (TclInstrumentTest.class) {
                    // Block reading before we do unwind:
                    if (redoIOPtr[0].beforePop) {
                        redoIOPtr[0].inRead
                                .release();
                        try {
                            TclInstrumentTest.class
                                    .wait();
        ...
        Engine engine = Engine
                .newBuilder()
                .in(delegateInputStream)
                .build();
        TestRedoIO redoIO = engine
                .getInstruments()
                .get("testRedoIO")
                .lookup(TestRedoIO.class);
        redoIOPtr[0] = redoIO;
        redoIO.inRead
                .drainPermits();
        Context context = Context
    ...
    public static class TestRedoIO
            extends
            TruffleInstrument {

        boolean beforePop = true;
        Semaphore inRead = new Semaphore(
                1);
    ...
    public void testEarlyReturn()
        ...
        EarlyReturnInstrument earlyReturn = context
                .getEngine()
                .getInstruments()
                .get("testEarlyReturn")
                .lookup(EarlyReturnInstrument.class);
        ...
        earlyReturn.fceCode = "fce(a)";
        earlyReturn.returnValue = new BigInteger(
                "-42");
        ...
        earlyReturn.returnValue = new TclBigNumber(
                new BigInteger(
                        "-42"));
        ret = context
                .eval(source);
    ...
    public static class EarlyReturnInstrument
            extends
            TruffleInstrument {
    ...
    public void testReplaceNodeReturnValue()
        ...
        final Source source = Source
                .newBuilder(
                        ...
                        "testing")
                .build();
        SourceSection ss = DebuggerTester
                .getSourceImpl(
                        source)
                .createSection(
                        24,
        ...
        Context context = Context
                .create();
        NewReplacedInstrument replaced = context
                .getEngine()
                .getInstruments()
                .get("testNewNodeReplaced")
                .lookup(NewReplacedInstrument.class);
        replaced.attachAt(
                ss);
    ...
    public static final class NewReplacedInstrument
            extends
            TruffleInstrument {
        ...
        static class ReplacedTruffleObject
                implements
                TruffleObject {
    ...
    public void testChangeArgumentsOnReenter()
        ...
        Context context = Context
                .create();
        IncreaseArgOnErrorInstrument incOnError = context
                .getEngine()
                .getInstruments()
                .get("testIncreaseArgumentOnError")
                .lookup(IncreaseArgOnErrorInstrument.class);
        incOnError
                .attachOn(
                        "A bad error");
    ...
    public static final class IncreaseArgOnErrorInstrument
            extends
            TruffleInstrument {
        ...
        void attachOn(
                String error) {
            EventBinding<ExecutionEventListener> reenterBinding = env
                    .getInstrumenter()
                    .attachExecutionEventListener(
                            SourceSectionFilter
                                    .newBuilder()
                            ...
                            new ExecutionEventListener() {
                                ...
                                public Object onUnwind(
                                        ...
                                        VirtualFrame frame,
                                        Object info) {
                                    frame.getArguments()[0] = (Long) frame
                                            .getArguments()[0]
                                            + 1;
                                    return ProbeNode.UNWIND_ACTION_REENTER;
                                }
    ...
    public static class EnvironmentHandlerInstrument
            extends
            TruffleInstrument {
